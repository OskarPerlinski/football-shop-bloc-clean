...
class GetRecommended extends StatelessWidget {
  const GetRecommended({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ProductsCubit(useCase: sl<GetRecommendedUseCase>())
        ..displayProducts(),
  ...
  Widget _getRecommendedForYouText() {
